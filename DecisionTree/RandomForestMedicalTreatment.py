...
class RandomForestMedicalTreatment(DecisionTree):
    """
    ...
    def Predict(self, data):
        ...
        risk_control = self._control_model.predict_proba(data)
        print(f"risk_control: {risk_control.shape}")
        # predict the risk of death using the treatment estimator
        risk_treatment = self._treatment_model.predict_proba(data)
...
if __name__ == "__main__":
    ...
    treatment = RandomForestMedicalTreatment("models/RandomForestMedicalTreatment.pkl", "models/RandomForestMedicalControl.pkl", 10, 10)
