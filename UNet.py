...
class UNet():
    ...
    _train_dataset = None
    _model: Model = None
    def __init__(self, path:str, input_size, n_filters:int, n_classes: int, buffer_size:int, batch_size:int):
        self._path = path
...
if __name__ == "__main__":
    ...
    # def __init__(self, input_size, n_filters:int, n_classes: int, buffer_size:int, batch_size:int):
    unet = UNet("models/UNet.keras", (img_height, img_width, num_channels), FILTERS, CLASSES, BUFFER_SIZE, BATCH_SIZE)
