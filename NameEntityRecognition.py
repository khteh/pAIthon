...
class NameEntityRecognition():
    ...
    def __init__(self, path:str, maxlen:int, learning_rate:float, batchsize:int, epochs:int):
        ...
        It is crucial that the tokenizer you use must match the Transformer model type you are using! In this exercise, you will use the 🤗 DistilBERT fast tokenizer, which standardizes the length of your sequence to 512 and pads with zeros. 
        Notice this matches the maximum length you used when creating tags.
        """
    ...
    def _tokenize_and_align_labels(self, data, label_all_tokens:bool = True):
        ...
        Before processing, it is important that you align the lists of tags and the list of labels generated by the selected tokenizer with a tokenize_and_align_labels() function.
