...
class SmilingFaceConvNet():
    ...
    def BuildModel(self):
        ...
        self._model = tf.keras.Sequential([
                ...
                layers.BatchNormalization(axis=3), # stabilize the learning process, accelerate convergence, and potentially improve generalization performance.
                ## ReLU
                layers.ReLU(),
...
if __name__ == "__main__":
    smilingFace = SmilingFaceConvNet()
    smilingFace.BuildModel()
    smilingFace.TrainEvaluate(10, 16)